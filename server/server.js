...
io.on("connection", (socket) => {
    ...
    // Emit updated online users: send current list directly to this client first (ensures new connection receives list),
    // then broadcast to others so everyone stays in sync.
